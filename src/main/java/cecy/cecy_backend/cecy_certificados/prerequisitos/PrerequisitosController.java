...
public class PrerequisitosController {
    ...
    @Autowired
    PrerequisitosService prerequisitosService;
    ...
    @PostMapping("/")
    public Prerequisitos save(@RequestBody Prerequisitos prerequisitos) {
        return prerequisitosService.save(prerequisitos);
    }
}
